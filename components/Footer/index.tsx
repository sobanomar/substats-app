...
import logoDark from "@/public/jiu-jitsu/subs-stats_logo-no-bg.png";
import logoLight from "@/public/jiu-jitsu/subs-stats_logo.jpg";

const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-white pt-16 dark:bg-gray-dark"
        data-wow-delay=".1s"
      >
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="">
                  <Image
                    src={logoDark}
                    alt="logo"
                    className="hidden w-40 object-cover dark:block"
                  />
                  <Image
                    src={logoLight}
                    alt="logo"
                    className="mb-4 w-40 rounded-xl object-cover dark:hidden"
                  />
                </Link>
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Sub Stats is a performance analytics platform designed for
                  Brazilian Jiu-Jitsu (BJJ) competitors and coaches.
                </p>
